  ...
  <MainLayout>
    ...
    <section class="space-y-6 max-w-4xl">
      ...
      <p class="text-zinc-600 dark:text-zinc-400 text-lg">
        A production-ready ERP platform designed to manage inventory, invoicing,
        sales workflows, audit logging, and multi-database architecture in a
        real operational environment.
      </p>
    </section>

    <section class="pt-24 max-w-3xl space-y-6">
      ...
      <p class="text-zinc-600 dark:text-zinc-400 leading-relaxed">
        ...
        growing transaction volume while maintaining audit traceability and data
        integrity across multiple database connections.
      </p>
    </section>
    ...
    <!-- ARCHITECTURE -->
    <section
      class="pt-24 py-24 bg-zinc-100 dark:bg-zinc-900/30 rounded-3xl px-10"
    >
      <h2 class="text-2xl font-semibold">System Architecture</h2>

      <div
        class="border border-zinc-200 dark:border-zinc-800 rounded-2xl p-10 bg-white dark:bg-zinc-900/40"
      >
        <div class="space-y-6 text-sm text-zinc-700 dark:text-zinc-300">
          <div class="flex items-center justify-between">
            <span>Vue 3 Frontend</span>
            <span>→</span>
            <span>Laravel API Layer</span>
          </div>

          <div class="flex items-center justify-between">
            <span>Service & Action Classes</span>
            <span>→</span>
          ...
          <div class="flex items-center justify-between">
            ...
            <span>↔</span>
            <span>MySQL (Secondary DB)</span>
          </div>

          <div class="flex items-center justify-between">
            <span>Audit Logging Layer</span>
            <span>→</span>
    ...
    <section class="pt-24 max-w-3xl space-y-6">
      ...
      >
        ...
        <li>Audit logging for traceability</li>
    ...
    <!-- RESULTS -->
    <section class="pt-24 max-w-3xl space-y-6 pb-32">
      ...
      >
        ...
        <li>Improved audit traceability</li>
        <li>Production stability with 24/7 uptime</li>
      </ul>
    </section>
  </MainLayout>
</template>
